...
// Misc. definitions from unrelated parts of blackmagic.
#define BOARD_IDENT "1Bitsy + cmdline"
...
static const struct usb_device_descriptor usbdd = {
...
#else
	// .bNumInterfaces = 5,
        .bNumInterfaces = (&ifaces)[1] - ifaces,
#endif
